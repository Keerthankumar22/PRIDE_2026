...
#     new_vne_req = []
    ...
    for i in range(len(new_vne_req)):
        ...
        # vne.append(graph_u.Graph(nodes, edges, Parameters(1,5,1,10,0,100,0,100,1,4))) 
        #vne.append(graph_u.Graph(nodes, edges, Parameters(1, 5, 1, 5, 0, 100, 0, 100, 1, 4))) DAA and VRMAP
        # For VIKOR and TOPSIS   Parameters(1,10,1,10,0,100,0,100,1,4)))
        # TOY example Parameters(10,20,10,20,0,100,0,100,1,4)))
